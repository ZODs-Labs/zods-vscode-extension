...
const ChatWelcomePanel = () => {
   const { isAuthenticated } = useTempState();

   return (
      <CenteredContainer h='full' pt='30px'>
         <Flex flexDirection='column' align='center' justify='start' gap={5}>
            <Flex direction='column' align='center' gap={4}>
               <BrandLogo />
               <Divider borderColor='#515251' w='60px' />
               ...
               <Flex gap={2} align='center'>
                  ...
                  <Text fontSize='md'>GPT-4.1</Text>
               </Flex>
            </Flex>

            <Flex pt={6}>{!isAuthenticated && <LoginButton />}</Flex>
            <FeaturesPanel />
         </Flex>
      </CenteredContainer>
   );
